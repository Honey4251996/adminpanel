...
<body>
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="index.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="flag" id="flag" value="signin">
                </div>
                <div class="mt-3">
                  <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">SIGN IN</button>
                </div>
                <div class="mt-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="create.php">SIGN UP</a>
                </div>
              </form>
            </div>
          </div>
  ...
  <?php 
    if(isset($msg)){ // Check if $msg is not empty
      echo "<script>alert('$msg');</script>"; // Display our message
    } ?>
  <!-- container-scroller -->
  <!-- plugins:js -->
